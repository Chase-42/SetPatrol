...
export const filters = [
  ...
  },
  {
    ...
    config: {
      options: [
        { key: 'audio_package', label: 'Audio Package' },
        { key: 'boom_shotgun', label: 'Boom / Shotgun' },
        { key: 'microphone', label: 'Microphone' },
        { key: 'mixer', label: 'Mixer' },
        { key: 'mixer_accessories', label: 'Mixer Accessories' },
        { key: 'portable_recorder', label: 'Portable Recorder' },
        { key: 'receiver', label: 'Receiver' },
        { key: 'wireless_receiver', label: 'Wireless Receiver' },
        { key: 'transmitter', label: 'Transmitter' },
        { key: 'audio_cable', label: 'Audio Cable' },
