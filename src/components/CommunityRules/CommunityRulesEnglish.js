...
import css from './CommunityRules.css'
...
const CommunityRules = () => {
    return (
        <div className='rules'>
            <br></br>
            <br></br>
            <h1 className={css.pageTitle}>SetPatrol Community Rules</h1>
            ...
            <p>Only accept requests you intend to proceed with. Your renter is depending on you and your equipment.</p>
                <ul>
                    <li>Do the paperwork.</li>
                </ul>
            <p>Practice good check-in and check-out procedures. Always use the checksheets.</p>
                <ul>
                    <li>Be helpful.</li>
                </ul>
            <p>Renters will remember the extra care and effort you put in. Your service is your reputation.</p>
                <ul>
            ...
            <p>Treat all equipment with respect and care. Tell the owner where you’re shooting.</p>
            <ul>
                <li>Communicate clearly.</li>
            </ul>
            <p>Arrange pick up and drop off timing and location in advance. Let the owner know immediately if there is an issue with the equipment.</p>
            <ul>
                <li>Do the paperwork.</li>
            </ul>
            <p>Practice good check-in and check-out procedures. Always use the checksheets.</p>
            ...
            <p>Be honest about your experience level. Don’t impersonate someone else.</p>
            <ul>
                <li>Keep it on SetPatrol.</li>
            </ul>
            <p>Don’t try to take transactions or messaging outside the site. Don’t encourage others to breach our Terms of Use.</p>
            ...
            <p>Do not discriminate against anyone based on their background.</p>
            <ul>
                <li>Respect each other’s time.</li>
            </ul>
            <p>Only inquire about Listings you are genuinely interested in purchasing.</p>
            <ul>
                <li>Over-communicate.</li>
            </ul>
            <p>Make sure you’re on the same page about the equipment. Double check about meeting location and timing. Show up early.</p>
            <ul>
                <li>Be honest.</li>
            </ul>
            <p>Do not misrepresent yourself, and do not pretend to be somebody else.</p>
            <ul>
                <li>Keep it on SetPatrol.</li>
            </ul>
            <p>Don’t try to take transactions or messaging outside the site. Don’t encourage others to breach our Terms of Use.</p>
            <h2>SetPatrol Buy & Sell Listing Conditions</h2>
            <p>Sellers are responsible for setting accurate Listing conditions and descriptions.</p>
            <p>SetPatrol has the following Listing conditions that a Seller can set:</p>
            <h3>Brand New</h3>
            <p>A brand-new, unused, unopened item in its original packaging (where applicable).</p>
            <h3>Like New</h3>
            <p>Pre-owned equipment, but appears as new. There are no signs of wear on the item.</p>
            <h3>Very Good</h3>
            <p>Very minor cosmetic damage on the body of the equipment, but nothing that interferes with the functionality of the equipment. Equipment works perfectly.</p>
            <h3>Good</h3>
            <p>Shows signs of use. Some cosmetic damage such as scrapes, scratches, or dings. Functions perfectly.</p>
            <h3>Acceptable</h3>
            <p>Shows signs of heavy use. May have some minor functional issues, which must be clearly described.</p>
            <h3>For Parts</h3>
