  ...
  render() {
    ...
    const renObjData = this.props.children.map(function(child, idx) {
      ...
      if (
        ...
        child.key == 'SearchFiltersMobile.cinema_camera_brands'
      ) {
        newChildren = newChildren.concat(child);
      }
      ...
      if (
        urlCategory == 'still_hybrid_cameras' &&
        child.key == 'SearchFiltersMobile.still_hybrid_cameras'
      ) {
        newChildren = newChildren.concat(child);
      }
      ...
      if (
        urlCategory == 'camera_accessories' &&
        child.key == 'SearchFiltersMobile.camera_accessories'
      ) {
        newChildren = newChildren.concat(child);
      }
      if (
        urlCategory == 'lighting_electric' &&
        child.key == 'SearchFiltersMobile.lighting_electric'
      ) {
        newChildren = newChildren.concat(child);
      }
      ...
      if (
        urlCategory == 'dit_media_management' &&
        child.key == 'SearchFiltersMobile.dit_media_management'
      ) {
        newChildren = newChildren.concat(child);
      }
      ...
      if (
        urlCategory == 'virtual_reality_and_new_tech' &&
        child.key == 'SearchFiltersMobile.virtual_reality_and_new_tech'
      ) {
        newChildren = newChildren.concat(child);
      }
      if (
        urlCategory == 'drones_and_vehicles' &&
        child.key == 'SearchFiltersMobile.drones_and_vehicles'
      ) {
        newChildren = newChildren.concat(child);
      }
      if (
        urlCategory == 'locations_and_spaces' &&
        child.key == 'SearchFiltersMobile.locations_and_spaces'
      ) {
        newChildren = newChildren.concat(child);
      }
    });
