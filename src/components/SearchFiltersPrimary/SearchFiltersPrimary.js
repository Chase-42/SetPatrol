...
const SearchFiltersPrimaryComponent = props => {
  ...
  const renObjData = props.children.map(function(child, idx) {
    ...
    if (
      ...
      child.key == 'SearchFiltersPrimary.still_hybrid_cameras'
    ) {
      newChildren = newChildren.concat(child);
    }
    ...
    if (
      ...
      child.key == 'SearchFiltersPrimary.camera_accessories'
    ) {
      newChildren = newChildren.concat(child);
    }
    if (
      urlCategory == 'lighting_electric' &&
      child.key == 'SearchFiltersPrimary.lighting_electric'
    ) {
      newChildren = newChildren.concat(child);
    }
    ...
    if (
      ...
      child.key == 'SearchFiltersPrimary.dit_media_management'
    ) {
      newChildren = newChildren.concat(child);
    }
    ...
    if (
      ...
      child.key == 'SearchFiltersPrimary.virtual_reality_and_new_tech'
    ) {
      newChildren = newChildren.concat(child);
    }
    if (
      urlCategory == 'drones_and_vehicles' &&
      child.key == 'SearchFiltersPrimary.drones_and_vehicles'
    ) {
      newChildren = newChildren.concat(child);
    }
    if (
      urlCategory == 'locations_and_spaces' &&
      child.key == 'SearchFiltersPrimary.locations_and_spaces'
    ) {
      newChildren = newChildren.concat(child);
    }
  });
