          ...
          <div className={css.contentWrapper}>
            <div className={css.contentMain}>
              ...
              <div className={css.aboutText}>
                <p>
                  SetPatrol is developing the largest community of filmmakers and photographers in
                  Europe. Our primary mission is to democratize the film industry by resolving the
                  problems every filmmaker faces; costs, gear, and space. As filmmakers ourselves,
                  we know how difficult it is to create when you are limited by circumstances, so we
                ...
                <p>
                  It doesn't end here. When you sign up, you will automatically become a member of
                  the SetPatrol community with access to a whole network of creators. Your profile
                  will showcase who you are and the work you have done. We give you a chance to meet
                  other people within the industry and stay connected through our website. You can
                  discover job opportunities, find resources, and learn more. Our first priority is
                  to help storytellers like you, so with SetPatrol you will never have to miss out
                  again.
                </p>
              </div>
              <div className={css.aboutVideo}>
                <iframe
                  src="https://player.vimeo.com/video/406087884"
                  frameborder="0"
